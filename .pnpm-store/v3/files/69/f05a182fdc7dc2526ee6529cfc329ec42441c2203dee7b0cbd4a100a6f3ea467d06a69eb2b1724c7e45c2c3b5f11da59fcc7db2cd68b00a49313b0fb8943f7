 ...
 */
export interface ConversationItemType extends AnyObject, Omit<React.HTMLAttributes<HTMLLIElement>, 'onClick'> {
    /**
     * @desc 唯一标识
...
export type GroupLabel = React.ReactNode | ((group: string, info: {
