...
export type SemanticType = 'root' | 'list' | 'item' | 'itemContent' | 'title' | 'subList' | 'subItem';
...
declare const Prompts: React.ForwardRefExoticComponent<PromptsProps & React.RefAttributes<ActionsRef>>;
