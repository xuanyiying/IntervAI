...
import { AIProvider } from '@/core/ai-provider/interfaces';
import { ModelConfigService } from '@/core/ai-provider/config/model-config.service';
import { QwenProvider } from '@/core/ai-provider/providers/qwen.provider';
import { OllamaProvider } from '@/core/ai-provider/providers/ollama.provider';
import { OpenAIProvider } from '@/core/ai-provider/providers/openai.provider';
import { DeepSeekProvider } from '@/core/ai-provider/providers/deepseek.provider';
import { GeminiProvider } from '@/core/ai-provider/providers/gemini.provider';
import { SiliconCloudProvider } from '@/core/ai-provider/providers/siliconcloud.provider';
import {
  QwenConfig,
  OllamaConfig,
  OpenAIConfig,
  ...
  GeminiConfig,
  SiliconCloudConfig,
} from '@/core/ai-provider/interfaces/model-config.interface';
import { ModelConfig } from '@/core/ai-provider/config/model-config.service';
import { AIError, AIErrorCode } from '@/core/ai-provider/utils/ai-error';
