...
export const useJobActions = (
  ...
  const { currentConversation, sendMessage, loadMessages } = useConversationStore();
  ...
  const handleJobCreated = useCallback(async (jobData: JobInput) => {
  ...
  const handleJobUpdated = useCallback(async (_updatedJob: Job) => {
