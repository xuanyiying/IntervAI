...
export const ResumeEditor: React.FC<ResumeEditorProps> = ({ activeSection, onUpdateSection }) => {
      ...
      <div className="space-y-12">
        <div className="space-y-4">
          ...
          <input
            ...
            onChange={(e) => onUpdateSection(activeSection.id, { title: e.target.value })}
        ...
        <div className="space-y-6">
          ...
          <textarea
            ...
            onChange={(e) => onUpdateSection(activeSection.id, { content: e.target.value })}
